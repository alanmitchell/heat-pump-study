function dynamicDataDisplayJNU1(axH)
%DYNAMICDATADISPLAYJNU1 is a function for the ASHP program for Juneau for heat pump 1. This function
...
% ------------ End of dynamicDataDisplay -----------------------
    ...
    function displayData(obj,ev,varargin)%This callback function displays performance characteristics (energy input, energy output, COP,etc.).
        ...
        global x logging_interval T_Outside P_input_HP1 P_output_HP1; %These were created in the ASHP program and now they are needed here.
        ...
        E_input=nansum(P_input_HP1(i1:i2))*logging_interval/1000; %Energy input in kWh
        E_output=nansum(P_output_HP1(i1:i2))*logging_interval/1000; %Energy output in kWh
